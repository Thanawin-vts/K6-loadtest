...
K6_ARGS=(
  ...
  -e "REPORT_BASENAME=buyer-visit-lot"
  -e "REPORT_TITLE=buyer visitLot"
)
...
K6_WEB_DASHBOARD=true K6_WEB_DASHBOARD_EXPORT=${REPORT_DIR}/buyer-visit-lot-dashboard.html k6 run "$K6_SCRIPT" "${K6_ARGS[@]}"
...
echo "Reports: ${REPORT_DIR}/buyer-visit-lot.{json,html}"
