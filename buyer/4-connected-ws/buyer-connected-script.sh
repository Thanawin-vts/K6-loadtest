...
K6_ARGS=(
  ...
  -e "REPORT_BASENAME=buyer-connected"
...
K6_WEB_DASHBOARD=true K6_WEB_DASHBOARD_EXPORT=${REPORT_DIR}/buyer-connected-dashboard.html k6 run "$K6_SCRIPT" "${K6_ARGS[@]}"
...
echo "Reports: ${REPORT_DIR}/buyer-connected.{json,html}"
