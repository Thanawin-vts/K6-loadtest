/**
 * k6 — login → lot-bidder-number → WS visitLot → WS connected
 *
 ...
 *   k6 run buyer/4-connected-ws/k6-buyer-visit-lot.js \
 ...
 *   REPORT_BASENAME=buyer-lot-connected
...
export const handleSummary = createHandleSummary(function () {
  return {
    titleBase: __ENV.REPORT_TITLE || 'k6 login → lot-bidder → visitLot → connected',
    reportDir: __ENV.REPORT_DIR || 'k6-reports',
    reportBasename: __ENV.REPORT_BASENAME || 'buyer-lot-connected',
    meta: {
      baseUrl: BASE_URL,
      wsUrl: WS_URL,
      lotId: LOT_ID,
